...
class EliminaLocalidadeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textViewLocalidadeEliminar = view.findViewById(R.id.textViewEliminaNomeLocalidade2)
        textViewCodigoPostalEliminar = view.findViewById(R.id.textViewEliminaCodigoPostal2)


        val local = DadosApp.localidadeSelecionado!!
        textViewLocalidadeEliminar.setText(local.nome)
